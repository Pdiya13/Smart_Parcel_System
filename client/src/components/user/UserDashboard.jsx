...
const UserDashboard = () => {
  ...
  return (
    <div className="d-flex flex-column vh-100 bg-light" style={{ padding: '15px' }}>
      <header className="d-flex justify-content-between align-items-center p-3 mb-3 rounded" style={{ backgroundColor: '#e8eaff' }}>
        <div className="d-flex align-items-center gap-2">
          <i className="bi bi-box-seam fs-3 text-primary"></i>
          <span className="fs-4 fw-semibold">Samaan</span>
        </div>
        <div className="d-flex align-items-center gap-2 fw-semibold">Dashboard <i className="bi bi-person-circle fs-4"></i></div>
      </header>

      <main className="flex-grow-1 bg-white rounded shadow p-4 overflow-auto">
        <h3 className="fw-bold mb-3">Your Orders</h3>
